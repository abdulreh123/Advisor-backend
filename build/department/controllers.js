...
class DepartmentsController extends Service_1.default {
    constructor() {
        super(...arguments);
        /**
        ...
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const department = yield this.createDepartment(req.body);
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { departmentId } = req.params;
                const body = req.body;
                const department = yield this.updateDepartment(departmentId, body);
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { departmentId } = req.params;
                const department = yield this.deleteDepartment(departmentId);
                res.status(200).json({ success: true, data: department });
            }
            catch (error) {
                res.status(400).json({
