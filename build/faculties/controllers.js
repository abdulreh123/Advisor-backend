...
class FacultyController extends Service_1.default {
    constructor() {
        super(...arguments);
        /**
        ...
        this.findAll = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const departments = yield this.getFaculties();
        ...
        this.findOne = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const department = yield this.getFaculty(departmentId);
        ...
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const department = yield this.createFaculty(req.body);
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { departmentId } = req.params;
                const body = req.body;
                const department = yield this.updateFaculty(departmentId, body);
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { departmentId } = req.params;
                const department = yield this.deleteFaculty(departmentId);
                res.status(200).json({ success: true, data: department });
            }
            catch (error) {
                res.status(400).json({
