...
router.get("/stats/:studentId/:departmentId", StudentControllers.studentStats);
router.get("/time-table/:studentId", StudentControllers.timeTable);
...
router.put("/approve/:studentId/:courseId", StudentControllers.courseApproval);
router.get("/get-approve/:studentId", StudentControllers.getNotApproval);
