...
export default class AdvisorController extends GroupService{
  ...
  findOne = async (req: any, res: any) => {
     ...
     * @param res
     */
     public setYear = async (req: any, res: any) => {
    try {
      const data = await this.setActiveYear(
        req.body
    )
     ...
     * @param res
     */
     public getYear = async (req: any, res: any) => {
    try {
      const data = await this.getActiveYear()
      res.status(200).json({ success: true, data: data });
    } catch (error:any) {
      res.status(400).json({
        success: false,
     ...
     * @param res
     */
     public offerCourses = async (req: any, res: any) => {
    try {
      const data = await this.openSemesterCourses()
      res.status(200).json({ success: true, data: data });
    } catch (error:any) {
      res.status(400).json({
        success: false,
